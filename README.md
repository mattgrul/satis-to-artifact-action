...
| Version | Status                                                                                                                                                                                                                                    | Nightly Build                                                                                                                                                                                                                        |
|---------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `main`  | [![Test Action](https://github.com/mattgrul/satis-to-artifact-action/actions/workflows/event-test-action.yml/badge.svg?branch=main)](https://github.com/mattgrul/satis-to-artifact-action/actions/workflows/event-test-action.yml)        | [![Test Action](https://github.com/mattgrul/satis-to-artifact-action/actions/workflows/nightly-main-test-action.yml/badge.svg)](https://github.com/mattgrul/satis-to-artifact-action/actions/workflows/nightly-main-test-action.yml) |
| `v1`    | [![Test Action](https://github.com/mattgrul/satis-to-artifact-action/actions/workflows/event-test-action.yml/badge.svg?branch=releases/v1)](https://github.com/mattgrul/satis-to-artifact-action/actions/workflows/event-test-action.yml) | [![Test Action](https://github.com/mattgrul/satis-to-artifact-action/actions/workflows/nightly-v1-test-action.yml/badge.svg)](https://github.com/mattgrul/satis-to-artifact-action/actions/workflows/nightly-v1-test-action.yml)     |
