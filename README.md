...
| Version | Status                                                                                                                                                                                                                                   |
|---------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `main`  | [![Test Action](https://github.com/mattgrul/satis-to-artifact-action/actions/workflows/test-action.yml/badge.svg?branch=main&event=push)](https://github.com/mattgrul/satis-to-artifact-action/actions/workflows/test-action.yml)        |
| `v1`    | [![Test Action](https://github.com/mattgrul/satis-to-artifact-action/actions/workflows/test-action.yml/badge.svg?branch=releases/v1&event=push)](https://github.com/mattgrul/satis-to-artifact-action/actions/workflows/test-action.yml) |
